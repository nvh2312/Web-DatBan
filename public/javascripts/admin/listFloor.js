...
function loadData() {
    $("#sample_data").DataTable({
      ...
      serverMethod: "get",
      ajax: {
        url: "http://localhost:3000/admin/api/getFloors",
      },
      aaSorting: [],
      columns: [
        {
...
$("#add_data").click(function () {
  $("label").remove(".error");
  $("#dynamic_modal_title").text("Add Floor");
...
$("#sample_form").on("submit", function (event) {
  if (validator.form()) {
    ...
    $.ajax({
      url: "http://localhost:3000/admin/api/actionFloor",
      method: "POST",
...
$(document).on("click", ".edit", function () {
  ...
  $("#dynamic_modal_title").text("Edit Floor");
